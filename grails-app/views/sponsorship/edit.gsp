                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: sponsorshipInstance, field: 'event', 'errors')}">
                                    <g:select name="event.id" from="${TekEvent.list()}" optionKey="id" value="${sponsorshipInstance?.event?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: sponsorshipInstance, field: 'sponsor', 'errors')}">
                                    <g:select name="sponsor.id" from="${Sponsor.list()}" optionKey="id" value="${sponsorshipInstance?.sponsor?.id}"  />
                                </td>
                            </tr>
