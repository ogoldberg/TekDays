                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:tekEventInstance,field:'organizer','errors')}">
                                    <input type="text" id="organizer" name="organizer" value="${fieldValue(bean:tekEventInstance,field:'organizer')}"/>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:tekEventInstance,field:'startDate','errors')}">
                                    <g:datePicker name="startDate" value="${tekEventInstance?.startDate}" precision="minute" ></g:datePicker>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:tekEventInstance,field:'endDate','errors')}">
                                    <g:datePicker name="endDate" value="${tekEventInstance?.endDate}" precision="minute" ></g:datePicker>
                                </td>
                            </tr> 
