...
<body>
  ...
  <div class="body">
    <h1><g:message code="Edit TekEvent" args="[entityName]" /></h1>
    ...
    <g:form method="post" >
      ...
      <div class="dialog">
        <table>
          ...
          <g:select name="organizer.id" from="${TekUser.list()}" optionKey="id" value="${tekEventInstance?.organizer?.id}"  />
          </td>
          </tr>
          ...
          <g:select name="volunteers" from="${TekUser.list()}" multiple="yes" optionKey="id" size="5" value="${tekEventInstance?.volunteers}" />
          </td>
          </tr>
